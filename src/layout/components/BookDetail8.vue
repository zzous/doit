<template>
    <section class="bookdetail">
      <h1 class="booktitle">
        일 잘하는 디자이너
        <span>클라이언트 설득부터 타이포그래피, 색상 선택, 면접 준비까지!</span>
      </h1>
      <div class="book-info">
        <div class="imgview">
      ...
      <div class="book-detailinfo">
        ...
        <template v-else-if="tapselect=='review'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"일 잘하는 디자이너"</strong>출판사 리뷰 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='order'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"일 잘하는 디자이너"</strong>목차 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='write'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"일 잘하는 디자이너"</strong>저자소개 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='recommendation'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"일 잘하는 디자이너"</strong>추천의 글 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='reference'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"일 잘하는 디자이너"</strong>자료실 입니다.</h1>

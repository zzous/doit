<template>
    <section class="bookdetail">
      <h1 class="booktitle">
        된다! 엑셀 수식 & 함수
        <span>복잡한 수식의 원리부터 함수 설명까지!</span>
      </h1>
      <div class="book-info">
        <div class="imgview">
      ...
      <div class="book-detailinfo">
        ...
        <template v-else-if="tapselect=='review'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 엑셀 수식 & 함수"</strong>출판사 리뷰 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='order'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 엑셀 수식 & 함수"</strong>목차 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='write'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 엑셀 수식 & 함수"</strong>저자소개 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='recommendation'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 엑셀 수식 & 함수"</strong>추천의 글 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='reference'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 엑셀 수식 & 함수"</strong>자료실 입니다.</h1>

<template>
    <section class="bookdetail">
      <h1 class="booktitle">
        Do it! SQL 입문
        <span>비전공자도 개발자도 쉽게 배우는 기초 문법 + 실용 예제</span>
      </h1>
      <div class="book-info">
        <div class="imgview">
      ...
      <div class="book-detailinfo">
        ...
        <template v-else-if="tapselect=='review'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"Do it! SQL 입문"</strong>출판사 리뷰 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='order'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"Do it! SQL 입문"</strong>목차 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='write'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"Do it! SQL 입문"</strong>저자소개 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='recommendation'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"Do it! SQL 입문"</strong>추천의 글 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='reference'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"Do it! SQL 입문"</strong>자료실 입니다.</h1>

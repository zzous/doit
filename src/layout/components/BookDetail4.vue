<template>
    <section class="bookdetail">
      <h1 class="booktitle">
        IT 5분 잡학사전
        <span>누구나 쉽게 이해할 수 있는 IT 지식이 가득한 입문서</span>
      </h1>
      <div class="book-info">
        <div class="imgview">
      ...
      <div class="book-detailinfo">
        ...
        <template v-else-if="tapselect=='review'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"IT 5분 잡학사전"</strong>출판사 리뷰 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='order'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"IT 5분 잡학사전"</strong>목차 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='write'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"IT 5분 잡학사전"</strong>저자소개 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='recommendation'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"IT 5분 잡학사전"</strong>추천의 글 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='reference'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"IT 5분 잡학사전"</strong>자료실 입니다.</h1>

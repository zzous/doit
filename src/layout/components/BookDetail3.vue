<template>
    <section class="bookdetail">
      <h1 class="booktitle">
        Do it! C# 프로그래밍 입문
        <span>딱 필요한 문법만 빠르게 배우고 프로젝트 실습까지!</span>
      </h1>
      <div class="book-info">
        <div class="imgview">
      ...
      <div class="book-detailinfo">
        ...
        <template v-else-if="tapselect=='write'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"Do it! C# 프로그래밍 입문"</strong>저자소개 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='recommendation'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"Do it! C# 프로그래밍 입문"</strong>추천의 글 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='reference'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"Do it! C# 프로그래밍 입문"</strong>자료실 입니다.</h1>
            <p>

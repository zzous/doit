<template>
    <section class="bookdetail">
      <h1 class="booktitle">
        된다! 아이패드 하루 24시간
        <span>굿노트, 프로크리에이트, 루마퓨전 사용법과 애플 연동, 아이패드 문제 해결까지!</span>
      </h1>
      <div class="book-info">
        <div class="imgview">
         <div class="imgbook"><img :src="imgurl" alt=""></div>
          <div class="bookbtns">
      ...
      <div class="book-detailinfo">
        ...
        <template v-else-if="tapselect=='review'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 아이패드 하루 24시간"</strong>출판사 리뷰 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='order'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 아이패드 하루 24시간"</strong>목차 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='write'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 아이패드 하루 24시간"</strong>저자소개 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='recommendation'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 아이패드 하루 24시간"</strong>추천의 글 입니다.</h1>
            <p>
        ...
        <template v-else-if="tapselect=='reference'">
          <div class="detailTapCon">
            <h1 class="tapcontit"><strong>"된다! 아이패드 하루 24시간"</strong>자료실 입니다.</h1>
